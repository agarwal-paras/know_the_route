...
void welcome()
{
 ...
 delay(500);
 outtextxy(10,225,"DATA STRUCTURES PROJECT");
 delay(500);
 outtextxy(200,300,"PRESENTATION");
 delay(2000);
 cleardevice();
 setbkcolor(YELLOW);
 setcolor(RED);
 ...
 delay(500);
 outtextxy(400,75,"JIIT");
 delay(500);
 outtextxy(325,120,"NAVIGATOR");
 delay(500);
 settextstyle(6,0,3);
 setcolor(GREEN);
 outtextxy(10,275,"SUBMITTED TO:");
 delay(500);
 outtextxy(10,295,"ANURADHA GUPTA");
 setcolor(BLUE);
 delay(1000);
 outtextxy(250,275,"SUBMITTED BY:");
 delay(500);
 settextstyle(6,0,3);
 outtextxy(250,295,"ANMOL AGARWAL (9913103439)");
 delay(500);
 outtextxy(250,320,"MANAV DHAR     (9913103427)");
 delay(500);
 outtextxy(250,345,"RISHABH GOYAL   (9913103431)");
 delay(500);
 outtextxy(250,370,"PRAKHAR SHUKLA (9913103445)");
 delay(2000);
 cleardevice();
 setbkcolor(RED);
 setcolor(YELLOW);
 ...
 settextstyle(8,0,3);
 outtextxy(20,60,"The JIIT Navigator is just a mini version of");
 outtextxy(20,90,"google maps.The diffrence is just the area");
 outtextxy(20,120,"covered by both of them.The user just need");
 outtextxy(20,150,"to enter his location and his destination in");
 outtextxy(20,180,"the college.The navigator will tell shortest ");
 outtextxy(20,210,"path in the college to his destination.");
 delay(1000);
}
void instruction()
{
 ...
 setcolor(RED);
 settextstyle(8,0,5);
 outtextxy(10,75,"NEXT PAGE");
 delay(500);
 outtextxy(160,150,"SHOWS");
 delay(500);
 outtextxy(200,225,"THE COMPLETE");
 delay(500);
...
void map1()
{
 ...
 //--------------//
line(10,460,200,460);
line(220,460,350,460);
line(370,460,500,460);
line(520,460,625,460);

line(200,460,200,500);
line(220,460,220,500);
settextstyle(11,0,1);
outtextxy(160,435,"FACULTY E.");
line(370,460,370,500);
outtextxy(340,430,"MAIN E.");
line(350,460,350,500);
line(520,460,520,500);
...
line(520,460,520,430);
line(520,430,625,430);
...
void map2()
{
 ...
 outtextxy(25,130,"CR-2");
 outtextxy(25,180,"CR-1");
 outtextxy(30,355,"<-TO STAIRS");
 outtextxy(115,90,"TR-2");
 outtextxy(265,90,"TR-3");
 outtextxy(310,80,"CABIN");
 outtextxy(520,200,"CABIN");
 outtextxy(500,280,"TO BLOCK B->");
 outtextxy(300,320,"TO STAIRS");
...
settextstyle(11,0,1);
 ...
 line(10,10,10,350);
 settextstyle(11,1,2);
 outtextxy(35,280,"ECE LAB");
 rectangle(10,250,50,350);    //ece lab
 line(100,200,100,350);
 outtextxy(130,390,"<-FACULTY B");
 settextstyle(11,0,0);
